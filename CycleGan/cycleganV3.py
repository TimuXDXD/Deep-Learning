...
class CycleGAN():
    ...
    def __init__(self):
        ...
        self.n_resnet = 6
        self.c_model_learning_rate = 0.0002
        # generator: A -> B
    ...
    def define_composite_model(self, g_model_1, d_model, g_model_2):
    	...
    	opt = Adam(lr=self.c_model_learning_rate, beta_1=0.5)
    ...
    def save_models(self, step, g_model_AtoB, g_model_BtoA):
    	...
    	filename1 = './saved_model/g_model_AtoB_%06d.h5' % (step+1)
    	g_model_AtoB.save(filename1)
    	# save the second generator model
    	filename2 = './saved_model/g_model_BtoA_%06d.h5' % (step+1)
    ...
    def summarize_performance(self, step, g_model, trainX, name, n_samples=5):
    	...
    	for i in range(n_samples):
    		...
    		plt.imshow(X_out[i])
    	# save plot to file
    	filename1 = './images/DFKai-SB2SimHei/%s_generated_plot_%06d.png' % (name, (step+1))
    ...
    def calculate_lr(self, n_epochs):
        return float(Decimal(str(self.c_model_learning_rate)) - Decimal(str(self.c_model_learning_rate / 100 * n_epochs)))
    ...
    def train(self):
    	...
    	for i in range(n_steps):
    		...
    		# decay learning rate
    		K.set_value(self.c_model_BtoA.optimizer.learning_rate, self.calculate_lr(int(n_steps/bat_per_epo)))
    		...
    		# decay learning rate
    		K.set_value(self.c_model_AtoB.optimizer.learning_rate, self.calculate_lr(int(n_steps/bat_per_epo)))
